...
<div style = "margin: 30px 50px;">
	<!-- 이미지 출력할곳 -->
	<img id = "showimg" style = "position: absolute; left: 500px; top: 150px; max-width: 300px;"
		src= "../save/<%=dto.getPhoto()%>">

	<form action = "updateboardaction.jsp" method = "post" enctype = "multipart/form-data">
		
		<table class = "table table-bordered" style = "width: 400px;">
			<caption align = "top"><b>게시글 쓰기</b></caption>
			<tr>
				<th bgcolor = "lightray" width = "100">작성자</th>
				<td>
			...
			<tr>
				<th style = "background-color: #bbb; width: 100">제목</th>
				<td>
					<input type = "text" name = "subject" class = "form-control" 
					style = "width: 130px;" required = "required"  value = "<%=dto.getSubject()%>">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan = "2">
					<textarea style = "width: 100%; height: 150px;" name = "content" required="required"  value = ""><%=dto.getContent()%></textarea>
				</td>
			</tr>
			<tr>
				<td colspan = "2">
					<button type = "submit" class = "btn btn-secondary btn-sm" name = "num" value = "<%=num%>">게시글저장</button>
