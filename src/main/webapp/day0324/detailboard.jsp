	...
	<table class = "table" style = "width: 600px;">
		...
		<tr>
			<td valign = "top">
				...
				<br><br>
				<!-- 저장시 br이 \n으로 db에 저장됨 그래서 출력시 다시 br로 바꿔야 한다
		...
		<tr>
			<td>
				...
				<i class = "bi bi-pencil-fill"></i>&nbsp;삭제</button>
				<button type="button" class = "btn btn-sm btn-outline-secondary"
				style = "width: 80px;" onclick = "location.href= 'boardlist.jsp'">
				<i class = "bi bi-pencil-fill"></i>&nbsp;목록</button>
			</td>
		</tr>
	</table>
</div>
